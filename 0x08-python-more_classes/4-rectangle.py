...
"""
    ...
    with getter and setter method for instance and attribute
    with some additional method including one which return string rep
    and also an executable string rep of class instances.
"""
