...
"""
    Module that implements a class Rectangle
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        for i in range(self.__height):
            for x in range(self.__width):
                if val := getattr(self, 'print_symbol'):
    ...
    def square(cls, size=0):
        "A class method that forms and return a square rectangle"
        ret_ins = Rectangle(size, size)
        return ret_ins
